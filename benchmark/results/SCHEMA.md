...
## Other committed result dirs

These are **not** regenerated by `make reproduce`. Field-level notes live
with each directory (this file remains the contract for the `$0`
`make reproduce` CSVs above):

- `headline_arena/` — [`headline_arena/SCHEMA.md`](headline_arena/SCHEMA.md) (`make arena-dry-run`)
- `hmm_regimes/` — [`hmm_regimes/README.md`](hmm_regimes/README.md) (`make hmm-regimes`)
- `multi_asset/` — [`multi_asset/README.md`](multi_asset/README.md) (`make multi-asset`)
- `survivorship/` — [`survivorship/README.md`](survivorship/README.md) (`make survivorship`)
- `chronos/` — [`chronos/README.md`](chronos/README.md) (`make chronos`)
- `qwen_n10/` — script docstring / `summary.json` (`make qwen-n10`; local Ollama, not fixture replay)
