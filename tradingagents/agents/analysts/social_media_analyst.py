...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            ...
            + " Additionally, you have access to **FinGPT Sentiment**, a specialized financial sentiment classifier inspired by FinGPT v3. Call `get_fingpt_sentiment_tool` **once** to obtain an aggregate sentiment score over recent headlines. Use it as a **complementary signal** — do not replace your qualitative analysis. If the tool returns unavailable, proceed with manual analysis."
